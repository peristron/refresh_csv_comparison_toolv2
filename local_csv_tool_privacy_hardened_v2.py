...
with st.expander("how to use this app", expanded=True):
    st.markdown(
        ...
        6. download the summary CSV or full report ZIP if you want to share or archive the results.
        7. inspect individual CSV comparisons in detail, or use manual ZIP/CSV pairing when needed.
        8. use **clear uploaded data** when finished to reset upload widgets and session state.
...
if old_zip_files and new_zip_files:
    ...
    st.info("Please upload old/reference ZIP files and new/target ZIP files to start.")
